...
function About() {
  return (
    <div className="bg-slate-100 dark:bg-dark_bg pt-10">
      <div className="container mx-auto px-4 md:px-8">
        ...
        {/* Our Story */}
        <section className="bg-white text-left dark:bg-slate-800 rounded-lg p-6 shadow-lg mb-10">
        ...
        <section className="bg-white text-left dark:bg-slate-800 rounded-lg p-6 shadow-lg mb-10">
          ...
          <ul className="list-disc pl-5 list-none  space-y-3">
        ...
        <section className="text-center">
          ...
          <a href="/contact">
            <button className="bg-primary hover:bg-recd-400 text-white font-semibold text-[16px] font-Poppins px-6 py-3 rounded-md transition-all duration-300">
              Contact Us
            </button>
          </a>
        </section>
